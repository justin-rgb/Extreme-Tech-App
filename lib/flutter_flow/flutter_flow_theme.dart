...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFFE64850);
  late Color secondaryColor = const Color(0xFFFFFFFF);
  late Color tertiaryColor = const Color(0xFFF4F4F4);
  late Color alternate = const Color(0xFF53555C);
  late Color primaryBackground = const Color(0xFF2B2D36);
