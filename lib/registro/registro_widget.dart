...
class _RegistroWidgetState extends State<RegistroWidget> {
  ...
  void initState() {
    ...
    _model.txtNombreRegController ??= TextEditingController();
    _model.txtNumeroTelRegController ??= TextEditingController();
    _model.txtCorreoRegController ??= TextEditingController();
    _model.txtPasswordRegController ??= TextEditingController();
  }
        ...
        body: SafeArea(
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    Expanded(
                      child: Container(
                        ...
                        child: TextFormField(
                          controller: _model.txtNombreRegController,
                          obscureText: false,
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(50.0, 25.0, 50.0, 0.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Expanded(
                      child: TextFormField(
                        controller: _model.txtNumeroTelRegController,
                        obscureText: false,
                        decoration: InputDecoration(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child: TextFormField(
                        controller: _model.txtPasswordRegController,
