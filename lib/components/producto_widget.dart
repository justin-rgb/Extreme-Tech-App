...
class ProductoWidget extends StatefulWidget {
  ...
  final ComponenteRecord? productos;
...
class _ProductoWidgetState extends State<ProductoWidget> {
  ...
  void initState() {
    ...
    _model.cantidadCarritoController ??= TextEditingController(text: '1');
  }
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 20.0, 0.0, 0.0),
                          child: Image.network(
                            widget.productos!.imageComponente!,
                            width: 405.9,
                            height: 228.2,
                            fit: BoxFit.cover,
                          ),
                                ...
                                children: [
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 20.0, 0.0, 0.0),
                                    child: Text(
                                      widget.productos!.descripcionComponente!,
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 5.0, 0.0, 0.0),
                                    child: Text(
                                      widget.productos!.precioComponente!
                                          .toString(),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium,
                                    ),
                            ...
                            Container(
                              ...
                              child: Align(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.cantidadCarritoController,
                                    obscureText: false,
                                    ...
                                    validator: _model
                                        .cantidadCarritoControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                        ...
                        onPressed: () async {
                          final carritoCreateData = createCarritoRecordData(
                            ...
                            cantidad: int.tryParse(
                                _model.cantidadCarritoController.text),
                            imagen: widget.productos!.imageComponente,
                            precio: widget.productos!.precioComponente,
                          );
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                content: Text('Se agrego al carrito'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
